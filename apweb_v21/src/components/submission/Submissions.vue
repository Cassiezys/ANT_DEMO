<template>
  <div>
	...
	<div class="content">
		<article class="markdown-body"><h2 id="paper-submission">Paper Submission<a class="headerlink" href="#paper-submission" title="Permanent link"></a></h2>
...
<p>It is the responsibility of authors to do their very best to preserve anonymity. Papers that do not follow the above GUILDLINES, or otherwise potentially reveal the identity of the authors, are subject to desk rejection.</p></article>
	</div>
